...
@section('page_awal')
    <a href="/user/dokumen_keuangan">Dokumen Keuangan</a>
@endsection

@section('page_aktif')
    Tambah dokumen keuangan
@endsection
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">Tambah Dokumen Keuangan</h4>

                    <form class="mb-0" action="/user/dokumen_keuangan_create/{{$id}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row form-material">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nm" class="form-control" value="{{$dokumen->nm ?? ''}}"  placeholder="Nama Dokumen Keuangan"/>
                            </div>
                            ...
                            @if ($dokumen->file ?? '')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="/user/download_dokumen_keuangan/{{$dokumen->file}}">
